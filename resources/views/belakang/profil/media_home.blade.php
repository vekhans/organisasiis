...
<div id="content-wrapper">
    <div class="container-fluid">
        <section class="content-header">
            <h4>
                Data <a>Media Profil :{!!' <strong>'.$media_profil->nama.'</strong>'!!}</a>
            </h4>
        </section>
                ...
                <div class="form-group">
                    <div class="form-row">
                        <div  class="col-md-8" style="text-align: left;"> 
                            ...
                            <a><i class="fa fa-edit"></i> Data Media Profil</a>
                        </div> 
                        <div  class="col-md-4" style="text-align: right;"> 
                            <a href="{{route('mepro.create',$media_profil->id)}}" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Tambah Data</a>
                    ...
                    <table class="table table-bordered table-responsive" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <form class="formDelete form-horizontal" action="{{route('mepro.destroy',[$media_profil->id,$val->id])}}" method="post">
