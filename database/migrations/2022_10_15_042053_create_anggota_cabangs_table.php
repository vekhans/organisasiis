...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('anggota_cabangs', function (Blueprint $table) {
            $table->id();
        ...
        schema::table('anggota_cabangs', function($table){
    ...
    public function down()
    {
        ...
        Schema::dropForeign(['id_anggota']);
        Schema::dropForeign(['id_cabang']);
        Schema::dropIfExists('anggota_cabangs');
    }
};
